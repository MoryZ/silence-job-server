...
public class NotifyConfig extends AbstractAutoGeneratedIdAuditableTenantable<BigInteger, String> {
    ...
    /**
     * 收件人关联关系（内存中使用，不映射到数据库）
     */
    @OneToMany(mappedBy = "notifyConfig")
    ...
    public List<NotifyConfigRecipientRelation> getRecipientRelations() {
        return recipientRelations;
    }

    public void setRecipientRelations(List<NotifyConfigRecipientRelation> recipientRelations) {
        this.recipientRelations = recipientRelations;
    }
}
