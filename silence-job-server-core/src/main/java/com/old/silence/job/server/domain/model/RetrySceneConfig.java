...
public class RetrySceneConfig extends AbstractAutoGeneratedIdAuditableTenantable<BigInteger, String> {
     ...
     */
    @OneToMany(mappedBy = "retrySceneConfig")
    ...
    public List<RetrySceneConfigNotifyConfigRelation> getNotifyRelations() {
        return notifyRelations;
    }

    public void setNotifyRelations(List<RetrySceneConfigNotifyConfigRelation> notifyRelations) {
