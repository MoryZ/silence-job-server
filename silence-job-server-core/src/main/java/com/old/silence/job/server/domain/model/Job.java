...
public class Job extends AbstractAutoGeneratedIdAuditableTenantable<BigInteger, String> {
    ...
    private List<JobTaskBatch> jobTaskBatches;
    ...
    public List<JobNotifyConfigRelation> getNotifyRelations() {
        return notifyRelations;
    }

    public void setNotifyRelations(List<JobNotifyConfigRelation> notifyRelations) {
    ...
    public List<JobTaskBatch> getJobTaskBatches() {
        return jobTaskBatches;
    }

    public void setJobTaskBatches(List<JobTaskBatch> jobTaskBatches) {
        this.jobTaskBatches = jobTaskBatches;
    }
}
